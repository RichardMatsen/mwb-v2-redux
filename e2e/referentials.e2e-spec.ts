...
describe('Referentials Page', () => {
  ...
  describe('title area', () => {
    it('should have a main title text', () => {
      expect<any>(page.titleText()).toEqual(config.referentialsConfig.page.pageTitle);
  });
    it('should have a sub title text', () => {
      expect<any>(page.subTitleText()).toEqual(config.referentialsConfig.page.pageDescription);
    });
  ...
  describe('file list', () => {
    it('should have title text', () => {
      expect(page.fileList_Title()).toEqual(config.referentialsConfig.page.listTitle);
    });
