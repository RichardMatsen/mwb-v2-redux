...
describe('Tasks Page', () => {
  ...
  describe('Kanban lists', () => {
    ...
    it('should have cards', () => {
      ...
      cy.get('mwb-kanban-card').arrayContains(['#1 - validations', '#2 - validations'])
    });
    ...
    it('should have one card on list #2', () => {
      cy.get('mwb-kanban-list').eq(1).within(els => {
        cy.root().get('mwb-kanban-card').count(1).contains('#2 - validations')
      })
    });
      ...
      */
      ...
      it('should drag and drop', () => {
        ...
        */
        ...
        cy.get('@draggable').trigger('dragstart', {dataTransfer: dt})
        cy.get('@droppable').trigger('drop', { dataTransfer: dt})
